    ...
    <div class="mx-auto w-96 flex flex-col gap-10">
       <h1 class="uppercase font-semibold text-3xl text-center">{{$heading}}</h1>
        <form class="flex flex-col gap-10">
          ...
          <x-form.textarea  type="text" placeholder="Description name in English" name="description" >
            {{ old('taskge') }}
          </x-form.textarea>
          <x-form.textarea  type="text" placeholder="Description name in Georgian" name="descriptionge" >
            {{ old('taskge') }}
          </x-form.textarea>

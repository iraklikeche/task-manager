<x-panel-layout class="pr-64">
  ...
  <div class="mx-auto w-96 flex flex-col gap-10">
    <h1 class="uppercase font-semibold text-3xl text-center">Edit Task</h1>
    ...
    <form class="flex flex-col gap-10">
      ...
      <button type="submit" class="bg-[#499af9] uppercase font-semibold py-4 rounded-xl mt-4 text-white">Edit Changes</button>
    </form>
  </div>
</x-panel-layout>